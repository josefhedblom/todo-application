...
import { user_signup, user_delete, user_login, user_update, user_veirfy, membersPage } from '../controllers/users.controllers';

UserRouter.get('/verifi-email', user_veirfy);
UserRouter.get("/members/:username", membersPage);
